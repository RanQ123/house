...
<TABLE class=field>
  ...
  <TR>
    ...
    <TD><INPUT id=add_action_title class=text value="${h.title}" type=text name=title> </TD>
    <TD> <INPUT id=d class=text value="${h.id}" type=hidden name=id></TD>
  </TR>
  <TR>
...
name=floorage></TD></TR>
  ...
  <TR>
    ...
    <TD>区：<SELECT class=text id="district_id" name=district_id></SELECT>
        街：<SELECT class=text name=streetId id="street_id"></SELECT> </TD></TR><!--
						<tr>
